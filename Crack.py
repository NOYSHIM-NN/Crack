...
jalan('\x1b[1;31mNOYSHIM CYBER  N-N CLONING START PLEASE WAIT ..........')
time.sleep(2)
os.system('clear')
loading()
...
\_/  \|\____//_/   \____/\_/ \|\_/\_/  \|
    ...
    \33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
    ║  \x1b[97m\033[37;41m  N-N FUCK FACEBOOK XD V2   \033[0;m     \33[1;92m ║
    \33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝            
     {H} ╔════════════════════════{M}════════════════╗
      {H}║{M}[{H}•{M}] AUTHOR    :{H} NOYSHIM CYBER             {N}{M}║
      {H}║{M}[{H}•{M}] FACEBOOK  : {H}MD NOYSHIM          {N}{M}║
      {H}║{M}[{H}•{M}] GITHUB    : {H}NOYSHIM-NN{N}       {H}  ║
      {M}║{M}[{H}•{M}] STATUS    : {H}FREE{P}     {N}  {H}      ║
      {M}║{M}[{H}•{M}] VERSION   : {H}unknown                  {H} ║
      {M}╚═════════════{H}═══════════════════════════╝ {P}""")
...
def main():
    ...
    print(f'{M}║══[•] VERSION   : {H}N-N')
    print(f'{M}╚══[•] CODER NAME: {H}NOYSHIM X')
    print(f' ')
    print(f"{M}╔══[{M}1{RED}] \033[1;32mSTART N-N  CLONING {RED}(N-N™)")
...
def _xxx_():
    ...
    print(f'{M}╚══[•] CODER NAME: {H}NOYSHIM X')
    print(f' ')
    print(f"{M}╔══[{M}1{RED}] \033[1;32mSTART N-N  RANDOM {RED}(N-N™)")
    print(f"{M}╔══[{M}2{RED}] \033[1;31mSTART N-N  X GMAIL {RED}(N-N™)")
...
def _FUCKER_():
    ...
    print(f' ')
    IP = ipm['origin']
    print(f'{M}╔══[•] TOOL NAME : {H}NOYSHIM FUCK')
    print(f'{M}║══[•] YOUR IP   :{H} '+IP)
    print(f'{M}║══[•] VERSION   : {H}N-N')
    print(f'{M}╚══[•] CODER NAME: {H}NOYSHIM HASAN')
    print(" ")
    print(f"{M}╔══[{H}1{M}] {COLOUR_X}CHOICE 6 DIGIT ID CLONING{RED} (N-N™) ")
    print(f"║══[{H}2{M}] {COLOUR_X}CHOICE 7 DIGIT ID CLONING{RED} (N-N™) ")
    print(f"║══[{H}3{M}] {COLOUR_X}CHOICE 8 DIGIT ID CLONING{RED} (N-N™) ")
    print(f"║══[{H}4{M}] {COLOUR_X}CHOICE 9 DIGIT ID CLONING{RED} (N-N™) ")
    print(f"║══[{H}5{M}] {COLOUR_X}CHOICE 10 DIGIT ID CLONING{RED} (N-N™) ")
    print(f"║══[{H}6{M}] {COLOUR_X}CHOICE 11 DIGIT ID CLONING{RED} (N-N™) ")
    print(f"║══[{H}7{M}] {COLOUR_X}CHOICE 12 DIGIT ID CLONING{RED} (N-N™) ")
    print(f"║══[{H}8{M}] {COLOUR_X}CHOICE 13 DIGIT ID CLONING{RED} (N-N™) ")
    print(f"║══[{H}9{M}] {COLOUR_X}CHOICE 14 DIGIT ID CLONING{RED} (N-N™) ")
